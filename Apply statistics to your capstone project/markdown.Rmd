...
``` {r echo = FALSE}
ggplot(AllComplaint) +
  geom_bar( aes(x = Offense.Description, y = stat(count)), col = "red") +
  theme(panel.grid = element_blank()) +
...
``` {r echo = FALSE}
ggplot(AllComplaint) +
  geom_bar( aes(x = Year, y = stat(count), fill = Offense.Description)) +
  theme(panel.grid = element_blank()) +
  scale_fill_brewer(palette = "Set1") +
  ylab("Number of Crimes") +
  ggtitle("Total Public Crime Complaints Annually Per Offense") 
...
``` {r echo = FALSE}
ggplot(AllComplaint, aes(x = Year, y = stat(count), fill = Offense.Description)) +
  geom_bar(position = "fill") +
  theme(panel.grid = element_blank()) +
  scale_fill_brewer(palette = "Set1") +
  ylab("Percentage of The Total Number of Crimes") +
...
``` {r echo = FALSE}
ggplot(AllComplaint, aes(x = Year, y = (..count..))) +
  geom_point(aes(col = Offense.Description),stat = "count") +
  geom_line(aes(col = Offense.Description), stat = "count") +
...
``` {r echo = FALSE}
ggplot(AllComplaint) +
  geom_bar( aes(x = Year, y = stat(count), fill = Premises)) +
  theme(panel.grid = element_blank()) +
...
``` {r echo = FALSE}
ggplot(AllComplaint, aes(x = Year, y = (..count..))) +
  geom_point(aes(col = Premises),stat = "count") +
  geom_line(aes(col = Premises), stat = "count") +
