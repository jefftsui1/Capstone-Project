...
##*Introduction*
Public offenses can be defined as an act that deviates society's general ideas of normal social behavior and moral values. Different types of public crime can happen anywhere in the city. Some borough has more crimes, others have less. By identifying the hotspots from the past crime reports, it will bring caution to tourists and locals to be aware of a certain area during certain times. 
...
####The number of public crime complaints per 100 people was calculated for each borough to see which borough have the most complaints.
```{r echo = TRUE}
...
The number of public crime complaints per 100 people for each boroughs bar graph show that Bronx has the most public crime complaints while Brooklyn have almost twice the amount of population. Staten Island have the least amount of population size and least amount of public crime complaints.
...
The majority of the total public crime complaints are from the street. Over the years, the percentage of street complaints have decreased while the percentage of transit - NYC subway have increased. 
...
Graphs shows that Shift1 have the least amount of crime complaints, followed by Shift2 and Shift3 has the most amount of crime complaints. There are fewer public crime complaints in Bronx than Manhattan and about the same number of public crime complaints in Queens during Shift1. But Bronx surpasses Manhattan and Queens number of public crime complaints during Shift2 and Shift3.
...
str(holiday)
```
The dataframe has 8 columns. The columns are: The complaint date, number of complaints of that day, average temperature of that day, if that day have precipitation greater than 3 inches, federal holidays descriptions, federal holidays, public schools closed descriptions, and public schools closed.
Precipitation greater than 3 inches has two factor levels, if the day have a precipitation greater than 3 inches then it will be "1 Yes" and if not then it will be "0 No".
